...
All included files can be used for free and configured freely according to your preference. If you need a fast response for technical support, contact me via email (luiifan@student.ppns.ac.id).
